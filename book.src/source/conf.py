...
htmlhelp_basename = 'sparkler007doc'
...
latex_documents = [
    (master_doc, 'sparkler007.tex', 'SYCL Sparkler: XeHE Homomorphic Encryption Library',
...
man_pages = [
    (master_doc, 'sparkler007', 'SYCL Sparkler: XeHE Homomorphic Encryption Library',
...
texinfo_documents = [
    (master_doc, 'sparkler007', 'SYCL Sparkler: XeHE Homomorphic Encryption Library',
     'Alexander Lyashevsky, Alexey Titov, Yiqin Qiu, and Yujia Zhai', 'sparkler007', 'An Intel GPU accelerated fully homomorphic encryption library written in C++ with SYCL.',
     'Miscellaneous'),
]
