function [gflops, op_density] = compute_gflops_radix_16(t)
    ...
    for i = 1 : size(t, 1)
        ...
        for j = 1 : size(t, 2)
            ...
            curr_t = t(i, j);
            if n == 4096
                total_ops = (log(4096) / log(16)) * 4096 / 16 * 1156 * rns;
            ...
            if n == 8192
                total_ops = ((log(4096) / log(16)) * 8192 / 16 * 1156 + 8192/2*48) * rns;
                curr_gflops = total_ops * 1e-3 / curr_t;
                gflops(i, j) = curr_gflops;
            ...
            if n == 16384
                total_ops = ((log(4096) / log(16)) * 16384 / 16 * 1156 + 16384/4*159) * rns;
                curr_gflops = total_ops * 1e-3 / curr_t;
                gflops(i, j) = curr_gflops;
            ...
            if n == 32768
                total_ops = ((log(4096) / log(16)) * 32768 / 16 * 1156 + 32768/8*459) * rns;
                curr_gflops = total_ops * 1e-3 / curr_t;
                gflops(i, j) = curr_gflops;
